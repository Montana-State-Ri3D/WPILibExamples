...
public class ElevatorSubsystem extends SubsystemBase {
        ...
        private final int kMaxPosition = 400;

        // Initial PID coefficients
        private static final double kP = 0.010000;
        private static final double kI = 0.000000;
        private static final double kD = 0.000000;
        private static final double kIz = 0.000000;
        private static final double kFF = 0.000100;
        private static final double kMaxOutput = 0.500000;
        private static final double kMinOutput = -0.500000;
        ...
        private void initTelemetry() {
                ...
                // State value entries
                curPosEntry = tab.add("Position", 0)
                                .withPosition(0, kStateRow)
                                .withSize(1, 1)
                                .getEntry();

                curTargetEntry = tab.add("Target", 0)
